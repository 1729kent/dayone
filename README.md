...
1. **[ライブダッシュボード](https://dayone-app-d2fceukfiq-an.a.run.app)** — 開いた瞬間に本番の実行履歴が見えます（毎朝07:00 JSTの定期入社が今日も動いています）。URL入力欄に**あなたの公開リポジトリ**を入れて試すこともできます
...
- **暴走封じ込め**: ステップ予算30 / アクション予算60 / ステップ300秒・Job全体10分のタイムアウト / 同一コマンド反復のループ検知 / 既存PRがあれば重複PRを作らない
